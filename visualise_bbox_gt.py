...
def draw_bbox(test_dataset, index, cfg, checkpoint_dir):
...
def main(cfg):
    ...
    index = 11
    # get_original_image(test_dataset, index)
    # get_transformed_image(test_dataset, index)
    # get_bbox_from_groundtruth(test_dataset, index, cfg)

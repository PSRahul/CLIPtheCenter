    ...
    def val(self):
        ...
        with torch.no_grad():
            with tqdm(enumerate(self.val_dataloader, 0), unit=" val batch") as tepoch:
                ...
                tepoch.set_postfix(val_loss=running_val_loss / len(self.val_dataloader),
                                       val_heatmap_loss=running_val_heatmap_loss / len(self.val_dataloader),
                                       val_bbox_loss=running_val_bbox_loss / len(self.val_dataloader),
                                       val_embedding_loss=running_val_embedding_loss / len(self.val_dataloader))
